...
{
    public class ErrorInfoMessageProcessorService : IMessageBrokerProcessorService
    {
        private readonly IExceptionLogRepository _exceptionLogRepository;

        public ErrorInfoMessageProcessorService(IExceptionLogRepository exceptionLogRepository)
        {
